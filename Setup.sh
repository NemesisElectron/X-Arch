...
sudo pacman --sync --noconfirm --needed firefox-developer-edition vlc davinci-resolve gimp audacity vscodium goverlay lact gparted mission-center obs-studio winetricks occt hardinfo2 alacritty plasma-login-manager wine-cachyos
...
sudo pacman --upgrade --noconfirm --overwrite "*" ./Files/X-Arch-1.0.0-1-x86_64.pkg.tar.zst
...
sudo chmod u+rwx /boot/loader/entries/cachyos.conf
...
yay --sync --noconfirm --needed reshade-shaders-git
